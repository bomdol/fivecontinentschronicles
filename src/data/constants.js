...
export const JOBS = {
  ...
  psychic:[
    {id:'fc',role:{ko:'전사형',en:'Warrior',zh:'战士型',ja:'戦士型',vi:'Chiến sĩ'},name:{ko:'역장사',en:'Force User',zh:'力场士',ja:'力場士',vi:'Lực trường sĩ'},sp:0,asc:' O\n/◎\\\n/ \\',desc:{ko:'염동력으로 적을 밀고 당긴다.',en:'Pushes and pulls enemies with telekinesis.',zh:'用念动力推拉敌人。',ja:'念動力で敵を押したり引いたりする。',vi:'Đẩy và kéo kẻ thù bằng念동력.'},s:{근력:65,민첩:70,지력:55,지혜:80,체력:65,매력:45}},
    ...
    {id:'aw',role:{ko:'특수 — 희귀',en:'Special',zh:'特殊',ja:'特殊',vi:'Đặc biệt'},name:{ko:'각성자',en:'Awakened',zh:'觉醒者',ja:'覚醒者',vi:'Người thức tỉnh'},sp:1,asc:' ◎!\n/!!\\\n/ \\',desc:{ko:'새사람 프로젝트 탈출체.',en:'Escaped subject of the New Human Project.',zh:'新人类计划的逃脱实验体。',ja:'新人間計画からの逃亡実験体。',vi:'Thực thể thoát khỏi Dự án Con Người Mới.'},s:{근력:60,민첩:80,지력:70,지혜:65,체력:70,매력:25}},
  ],
};
...
export const STORY_CHAPTERS = [
  { id:1, name:'전초기지 건설',              turns:10,
    ...
    events:[
      {desc:'건설 자재 확보를 위한 주변 탐사', prob:100},
      {desc:'탐사 도중 괴물과의 조우',         prob:50},
      {desc:'건설 과정에서 사소한 사고 발생',  prob:30},
      {desc:'영역을 침범당한 괴물의 습격',     prob:30},
    ]},
  { id:2, name:'전초기지 확장 및 광맥 탐사', turns:15,
    main:'기지가 안정되며 주변 자원과 광맥 탐사 시작.',
    events:[
      {desc:'광맥 발견을 위한 정찰 임무',            prob:100},
      {desc:'정찰 중 괴물 은신처 발견',              prob:40},
      {desc:'채굴 장비 고장으로 인한 수리 작업',     prob:30},
      {desc:'탐사대 내부 갈등 — 자원 분배 문제',    prob:20},
    ]},
  { id:3, name:'대륙 탐사',                  turns:20,
    main:'대륙 깊숙한 곳으로 탐사 확장.',
    events:[
      {desc:'새로운 광맥 발견',           prob:100},
      {desc:'고대 문명 흔적 발견',        prob:40},
      {desc:'갱도 내 괴물과의 전투',      prob:50},
      {desc:'탐사 중 실종자 발생',        prob:20},
    ]},
  { id:4, name:'타 대륙 개척단 조우',        turns:10,
    main:'다른 대륙에서 온 개척단과 첫 접촉.',
    events:[
      {desc:'우호적 교류 — 기술/마법/무공 교환', prob:50},
      {desc:'긴장된 대치 — 자원 확보 경쟁',      prob:40},
      {desc:'오해로 인한 충돌',                   prob:20},
    ]},
  { id:5, name:'대륙 간 협력과 경쟁',        turns:15,
    main:'자원 확보와 세력 확장 경쟁.',
    events:[
      {desc:'공동 탐사 프로젝트 추진',          prob:40},
      {desc:'자원 채굴권을 둘러싼 갈등',        prob:50},
      {desc:'개척단 내부 배신 사건',            prob:20},
    ]},
  { id:6, name:'잠든 미르 발견',             turns:8,
    main:'대륙 깊은 곳에서 전설의 미르(드래곤) 존재 확인.',
    events:[
      {desc:'미르의 봉인 흔적 발견',             prob:40},
      {desc:'미르의 하수인과의 전투',            prob:50},
      {desc:'미르의 힘에 의해 환경 변화 발생',   prob:30},
    ]},
  { id:7, name:'미르와의 결전',              turns:12,
    main:'모든 개척단이 힘을 합쳐 미르와 결전.',
    events:[
      {desc:'미르의 약점을 찾아내는 특별 임무', prob:40},
      {desc:'전투 중 개척단 간 협력 강화',      prob:50},
      {desc:'미르의 예기치 못한 변이',          prob:30},
    ]},
  { id:8, name:'협력과 신뢰의 자리매김',     turns:6,
    main:'미르 격퇴 후, 각 개척단이 서로의 영역과 체계를 인정.',
    events:[
      {desc:'무공과 마법의 융합 시도',             prob:30},
      {desc:'초능력과 기술의 상호 보완',           prob:30},
      {desc:'개척단 연합 결성 — 테라 노바 연합',  prob:50},
    ]},
];
